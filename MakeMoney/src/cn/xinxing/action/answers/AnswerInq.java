package cn.xinxing.action.answers;
 ...
 */
@WebServlet("/AnswerInq")
public class AnswerInq extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Answers> list = AnswerBusiness.getAllAnswers();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(type.equals("add")) { 
			...
			AnswerBusiness.addAnswer(publisher_id, publisher_name, answerer_id, answerer_name, title, price, description, answer_1, answer_2, answer_3, answer_4, answer_5);
			...
			list.add(AnswerBusiness.getAnswerInfo(publisher_id, answerer_id, title));
			listObject.setItems(list);
			listObject.setStatusObject(StatusHouse.COMMON_STATUS_OK);
		} else {
